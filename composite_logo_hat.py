...
def process():
    fg_path = r"public\images\products\logo-hat-clear.png"
    bg_path = r"C:\Users\rojas\.gemini\antigravity-ide\brain\b342c7ee-4338-4f68-8e57-93d47dfceb0b\jdm_garage_background_1783904361670.png"
    out_path = r"public\images\products\logo-hat-final-bg.png"
    ...
    # Push it down just a tiny bit more for visual balance
