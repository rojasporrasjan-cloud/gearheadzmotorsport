...
def extract_perfect():
    ...
    clear_path = r"c:\Users\rojas\Desktop\Clientes\headmotorz\public\images\products\Need-speed-clear.png"
    colored_path = r"c:\Users\rojas\Desktop\Clientes\headmotorz\public\images\products\Need-speed.png"
    out_path = r"c:\Users\rojas\Desktop\Clientes\headmotorz\public\images\products\need-speed-perfect.png"
    
    clear_img = Image.open(clear_path).convert("RGBA")
    colored_img = Image.open(colored_path).convert("RGBA")
    
    if clear_img.size != colored_img.size:
        print(f"Resizing colored image {colored_img.size} to match clear image {clear_img.size}")
        colored_img = colored_img.resize(clear_img.size, Image.Resampling.LANCZOS)
