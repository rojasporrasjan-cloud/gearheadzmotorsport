...
fg_path = r"c:\Users\rojas\Desktop\Clientes\headmotorz\public\images\products\turbo-girl-fixed.png"
...
process(bg1, fg_path, os.path.join(out_dir, "preview_toxica_1_fixed.png"))
process(bg2, fg_path, os.path.join(out_dir, "preview_toxica_2_fixed.png"))
