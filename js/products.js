...
export const PRODUCTS = [
  // ── TEES ──────────────────────────────────────────
  {
    ...
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/180sx-tee.png',
  },
  {
    id: 'p-911', name: '911 TEE',
    price: 20, cat: 'APPAREL', badge: null, stock: 10,
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/911-tee.png',
  },
  {
    id: 'p-bluezilla', name: 'BLUEZILLA GODZILLA TEE',
    price: 30, cat: 'APPAREL', badge: 'NEW DROP', stock: 8,
    sizes: ['XS','S','M','L','XL'],
    img: '/images/products/bluezilla-godzilla-tee.png',
  },
  {
    id: 'p-bluzilla', name: 'BLUZILLA TEE',
    price: 30, cat: 'APPAREL', badge: null, stock: 10,
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/bluzilla-tee.png',
  },
  {
    id: 'p-gtr', name: 'GTR TEE',
    price: 20, cat: 'APPAREL', badge: null, stock: 10,
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/gtr-tee.png',
  },
  {
    id: 'p-labubi-miata', name: 'LABUBI MIATA TEE',
    price: 30, cat: 'APPAREL', badge: null, stock: 10,
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/labubi-miata-tee.png',
  },
  {
    id: 'p-miata', name: 'MIATA TEE',
    price: 30, cat: 'APPAREL', badge: null, stock: 10,
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/miata-tee.png',
  },
  {
    id: 'p-rotary', name: 'ROTARY TEE',
    price: 30, cat: 'APPAREL', badge: null, stock: 10,
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/rotary-tee.png',
  },
  {
    id: 'p-sakura', name: 'SAKURA TEE',
    price: 30, cat: 'APPAREL', badge: null, stock: 10,
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/sakura-tee.png',
  },
  {
    id: 'p-forever-static', name: 'FOREVER STATIC TEE',
    price: 20, cat: 'APPAREL', badge: null, stock: 10,
    sizes: ['S','M','L','XL','2XL'],
    img: '/images/products/forever-static-tee.png',
  },
  // ── KIDS ──────────────────────────────────────────
  {
    ...
    sizes: ['XS','S','M','L','XL'],
    img: '/images/products/kids-labubi-miata-tee.png',
  },
  {
    id: 'p-kids-bluezilla', name: 'KIDS BLUEZILLA GODZILLA TEE',
    price: 20, cat: 'KIDS', badge: null, stock: 0,
    sizes: ['XS','S','M','L'],
    img: '/images/products/kids-bluezilla-godzilla-tee.png',
  },
  // ── HEADWEAR ──────────────────────────────────────
  {
  ...
  },
  {
    ...
    sizes: ['ONE SIZE'],
    img: '/images/products/logo-hat-white.png',
  },
  {
  ...
  // ── ACCESSORIES ───────────────────────────────────
  {
    ...
    sizes: ['ONE SIZE'],
    img: '/images/products/i-identify-as-water-koozie.png',
  },
  {
  ...
  },
  {
    ...
    sizes: ['ONE SIZE'],
    img: '/images/products/turbo-clean-soap.png',
  },
  {
    id: 'p-plushie', name: 'TURBI PILLOW PLUSHIE',
    price: 30, cat: 'ACCESSORIES', badge: 'LIMITED', stock: 0,
    sizes: ['ONE SIZE'],
    img: '/images/products/turbi-pillow-plushie.png',
  },
];
